...
entity VI_videoout is
   ...
   (           
      ...
      VI_SHADOW_TEXRECT0_VALID         : in  std_logic;
      VI_SHADOW_TEXRECT0_X0            : in  unsigned(9 downto 0);
...
architecture arch of VI_videoout is
   ...
   signal shadow_text           : unsigned(551 downto 0);
   ...
   signal shadow_last_texrect_dropped : unsigned(15 downto 0) := (others => '0');
...
begin 
   ...
   (
      ...
      texrect_count => VI_SHADOW_TEXRECT_COUNT,
      texrect_valid => VI_SHADOW_TEXRECT_VALID,
      texrect_x0 => VI_SHADOW_TEXRECT_X0,
      texrect_x1 => VI_SHADOW_TEXRECT_X1,
      texrect_y0 => VI_SHADOW_TEXRECT_Y0,
      texrect_y1 => VI_SHADOW_TEXRECT_Y1,
      texrect0_valid => VI_SHADOW_TEXRECT0_VALID,
      texrect0_x0 => VI_SHADOW_TEXRECT0_X0,
      texrect0_x1 => VI_SHADOW_TEXRECT0_X1,
      texrect0_y0 => VI_SHADOW_TEXRECT0_Y0,
      texrect0_y1 => VI_SHADOW_TEXRECT0_Y1,
      texrect0_tile => VI_SHADOW_TEXRECT0_TILE,
      texrect0_flip => VI_SHADOW_TEXRECT0_FLIP,
      texrect1_valid => VI_SHADOW_TEXRECT1_VALID,
      texrect1_x0 => VI_SHADOW_TEXRECT1_X0,
      texrect1_x1 => VI_SHADOW_TEXRECT1_X1,
      texrect1_y0 => VI_SHADOW_TEXRECT1_Y0,
      texrect1_y1 => VI_SHADOW_TEXRECT1_Y1,
      texrect1_tile => VI_SHADOW_TEXRECT1_TILE,
      texrect1_flip => VI_SHADOW_TEXRECT1_FLIP,
      texrect2_valid => VI_SHADOW_TEXRECT2_VALID,
      texrect2_x0 => VI_SHADOW_TEXRECT2_X0,
      texrect2_x1 => VI_SHADOW_TEXRECT2_X1,
      texrect2_y0 => VI_SHADOW_TEXRECT2_Y0,
      texrect2_y1 => VI_SHADOW_TEXRECT2_Y1,
      texrect2_tile => VI_SHADOW_TEXRECT2_TILE,
      texrect2_flip => VI_SHADOW_TEXRECT2_FLIP,
      texrect3_valid => VI_SHADOW_TEXRECT3_VALID,
      texrect3_x0 => VI_SHADOW_TEXRECT3_X0,
      texrect3_x1 => VI_SHADOW_TEXRECT3_X1,
      texrect3_y0 => VI_SHADOW_TEXRECT3_Y0,
      texrect3_y1 => VI_SHADOW_TEXRECT3_Y1,
      texrect3_tile => VI_SHADOW_TEXRECT3_TILE,
      texrect3_flip => VI_SHADOW_TEXRECT3_FLIP,
   ...
   begin
      if rising_edge(clk1x) then
         ...
         if (reset_1x = '1') then
            ...
            shadow_last_texrect_dropped <= (others => '0');
            ...
            if (VI_SHADOW_FRAME_STROBE = '1' and VI_SHADOW_ENABLE = '1' and (VI_SHADOW_MODE = "01" or VI_SHADOW_MODE = "10") and VI_SHADOW_UNSUPPORTED_CMDS /= 0) then
               ...
               shadow_last_texrect_dropped <= VI_SHADOW_TEXRECT_DROPPED;
   ...
   shadow_text <= to_unsigned("VXS M") &
                  ...
                  to_unsigned(" X") &
                  conv_number(shadow_last_texrect_dropped) &
                  to_unsigned(" V") &
                  ...
                  to_unsigned(" S") &
                  conv_number(shadow_unsupported_streak) &
                  to_unsigned(" F") &
   ...
   ioverlayVIShadow : entity work.VI_overlay generic map (69, 14, 26, x"007070")
   port map
   (
      clk                    => clkvid,
      ce                     => videoout_out.ce,
